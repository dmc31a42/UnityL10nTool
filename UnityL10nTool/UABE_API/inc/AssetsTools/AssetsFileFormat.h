...
struct AssetsFileDependency
{
	...
	ASSETSTOOLS_API QWORD Read(QWORD absFilePos, IAssetsReader *pReader, bool bigEndian);
	ASSETSTOOLS_API QWORD Write(QWORD absFilePos, IAssetsWriter *pWriter, bool bigEndian);
};
...
struct TypeField_0D
{
	...
	DWORD flags;			//0x14
	ASSETSTOOLS_API QWORD Read(QWORD absFilePos, IAssetsReader *pReader, bool bigEndian);
	ASSETSTOOLS_API QWORD Write(QWORD curFilePos, IAssetsWriter *pWriter, bool bigEndian);
...
class AssetsFile
{
	public:
		...
		ASSETSTOOLS_API QWORD Write(IAssetsWriter *pWriter, QWORD filePos, AssetsReplacer **pReplacers, size_t replacerCount, DWORD fileID,
