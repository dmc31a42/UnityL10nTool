...
ASSETSTOOLS_API void AssetsVerifyLoggerToMessageBox(char *message);
...
ASSETSTOOLS_API IAssetsWriterToMemory *Create_AssetsWriterToMemory(size_t initialLen = 0, size_t maximumLen = (size_t)-1LL);
